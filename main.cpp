...
void web_server_thread_function(std::unique_ptr<httplib::Server> server) {
...
int main(int argc, char *argv[]) {
	...
	auto srv = std::unique_ptr<httplib::Server>(new httplib::Server());
	...
	// start threads
	std::thread web_server_thread(web_server_thread_function, std::move(srv));
