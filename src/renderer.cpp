...
void EmotionDrawer::draw(rgb_matrix::Canvas& canvas, ProtogenHeadState::Emotion emotion, Proportion eye_openness) const {
...
void ProtogenHeadFrameProvider::draw(rgb_matrix::Canvas& canvas, ProtogenHeadState::Emotion emotion, Proportion mouth_openness, EmotionDrawer& emotion_drawer, image::ImageSpectrum& mouth_images, image::StaticImageDrawer& static_drawer, bool blank, Proportion eye_openness) {
    if(!blank) {
        // mouth
...
void MinecraftDrawer::draw(rgb_matrix::Canvas& canvas, const MinecraftState& state) const {
    drawWorld(canvas, state.blockMatrix(), state.blockColorProfile());
    drawPlayers(canvas, state);
}

void MinecraftDrawer::drawWorld(rgb_matrix::Canvas& canvas, const mc::BlockMatrix& block_matrix, const mc::BlockColorProfile& color_profile) {
...
void MinecraftDrawer::drawPlayers(rgb_matrix::Canvas& canvas, const MinecraftState& state) {
...
void MinecraftDrawer::drawPlayer(rgb_matrix::Canvas& canvas, const MinecraftPlayerState& player_state, const mc::BlockColorProfile& color_profile) {
...
void Renderer::render(const AppState& data, rgb_matrix::Canvas& canvas) {
...
void Renderer::viewProtogenHeadData(const ProtogenHeadState& data, rgb_matrix::Canvas& canvas) {
...
void Renderer::viewMinecraftData(const MinecraftState& data, rgb_matrix::Canvas& canvas) {
